  ...
  render() {
    ...
    return (
      ...
      //Projectpage
        ...
        //           <Grid className="foreground-parallax" container spacing={24} style={{width: '97%', marginTop: 420}}>
                    
        //             <Grid container spacing={16}>
                    
        //               <Grid item xs={12}>
        //                 <div className="projects-title-page">
        //                   <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="583.667px" height="66.167px" viewBox="0 5 30 40" enable-background="new 0 0 183.667 46.167">
        //                     <g id="Layer_4">
        //                       <g>
        ...
        //                         <Paper style={{marginTop: this.state.spacingForProjects}} className="projects-description-card" >
